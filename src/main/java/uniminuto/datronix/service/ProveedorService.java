...
@Service
// Aplica el flujo de proveedores: convertir datos, consultar la base y devolver resultados.
public class ProveedorService {
    ...
    public ProveedorDTO buscarProveedorPorId(Long id) {
        // Si no existe el ID, la excepción específica permite responder con un mensaje adecuado.
